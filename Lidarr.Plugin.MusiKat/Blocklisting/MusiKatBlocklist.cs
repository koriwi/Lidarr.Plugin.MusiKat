...
{
    public class MusiKatBlocklist : IBlocklistForProtocol
    {
        private readonly IBlocklistRepository _blocklistRepository;

        public MusiKatBlocklist(IBlocklistRepository blocklistRepository)
        {
            _blocklistRepository = blocklistRepository;
        }

        public string Protocol => nameof(MusiKatDownloadProtocol);
        ...
        public bool IsBlocklisted(int artistId, ReleaseInfo release)
        {
            ...
            return blocklistedByGuid.Any(b => SameRelease(b, release));
        }
